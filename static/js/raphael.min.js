    ...
    return function(t) {
        ...
        i = [r(2)], n = function(t) {
                ...
                if (l) {
                    if (h) h.initstatus = a, h.start = new Date - h.ms * a;
                            ...
                            if (l[T](C) && (pt[T](C) || i.paper.customAttributes[T](C))) switch (v[C] = i.attr(C), null == v[C] && (v[C] = ft[C]), m[C] = l[C], pt[C]) {
                                ...
                                case "path":
                                    ...
                                    for (v[C] = A[0], b[C] = [], w = 0, B = v[C].length; B > w; w++) {
                                        b[C][w] = [0];
                                        for (var M = 1, N = v[C][w].length; N > M; M++) b[C][w][M] = (E[w][M] - v[C][w][M]) / x
                                    }
                                    break;
                                case "transform":
                                    var L = i._,
                                    ...
                                    if (z)
                                        for (v[C] = z.from, m[C] = z.to, b[C] = [], b[C].real = !0, w = 0, B = v[C].length; B > w; w++)
                                            for (b[C][w] = [v[C][w][0]], M = 1, N = v[C][w].length; N > M; M++) b[C][w][M] = (m[C][w][M] - v[C][w][M]) / x;
                                    else {
                        ...
                        if (d = l.start || r.start || +new Date, _ = {
                                ...
                                origin: i.attr(),
                                totalOrigin: s
                            }, Ee.push(_), a && !h && !u && (_.stop = !0, _.start = new Date - x * a, 1 == Ee.length)) return Ne();
                ...
                Ut = function(t, e, r, i, a, s, o, l, h, u) {
                    ...
                    if (H(A) > c) {
                        var E = T,
                            M = l,
                            N = h;
                        T = S + c * (o && T > S ? 1 : -1), l = B + r * Y.cos(T), h = C + i * Y.sin(T), p = Ut(l, h, r, i, a, 0, o, M, N, [T, E, B, C])
                    }
                    A = T - S;
                    var L = Y.cos(S),
                        z = Y.sin(S),
            ...
            N.getElementByPoint = function(t, e) {
                ...
                var e = this._;
                return t ? (!e.dirty && e.bboxwt || (this.realPath = Et[this.type](this), e.bboxwt = Ot(this.realPath), e.bboxwt.toString = v, e.dirty = 0), e.bboxwt) : ((e.dirty || e.dirtyT || !e.bbox) && (!e.dirty && this.realPath || (e.bboxwt = 0, this.realPath = Et[this.type](this)), e.bbox = Ot(Mt(this.realPath, this.matrix)), e.bbox.toString = v, e.dirty = e.dirtyT = 0), e.bbox)
            }, ye.clone = function() {
                    ...
                    _ = function(i, n, a) {
                        if ("path" == i.type) {
                            ...
                            if ("open" == v ? (k += 2, B += 2, C += 2, b = 1, _ = a ? 4 : 1, w = {
                                ...
                                var M = b * ("diamond" != v && "oval" != v);
                                a ? (y = i._.arrows.startdx * f || 0, m = t.getTotalLength(u.path) - M * f) : (y = M * f, m = t.getTotalLength(u.path) - (i._.arrows.enddx * f || 0)), w = {}, w["marker-" + l] = "url(#" + T + ")", (m || y) && (w.d = t.getSubpath(u.path, y, m)), x(h, w), i._.arrows[l + "Path"] = S, i._.arrows[l + "Marker"] = T, i._.arrows[l + "dx"] = M, i._.arrows[l + "Type"] = v, i._.arrows[l + "String"] = n
                                    ...
                                    case "clip-rect":
                                        ...
                                        if (!g) {
                                            ...
                                            if (E) {
                                                ...
                                                M && M.parentNode.removeChild(M), x(l, {
                                                    "clip-path": c
                                                }), delete i.clip
                                            }
                                        }
                    ...
                    T = function(n, l) {
                        ...
                        if (v && (f.path = t._getPath[n.type](n), n._.dirty = 1), l.href && (c.href = l.href), l.title && (c.title = l.title), l.target && (c.target = l.target), l.cursor && (g.cursor = l.cursor), "blur" in l && n.blur(l.blur), (l.path && "path" == n.type || v) && (c.path = k(~r(f.path).toLowerCase().indexOf("r") ? t._pathToAbsolute(f.path) : f.path), n._.dirty = 1, "image" == n.type && (n._.fillpos = [f.x, f.y], n._.fillsize = [f.width, f.height], C(n, 1, 1, 0, 0, 0))), "transform" in l && n.transform(l.transform), y) {
                            var T = +f.cx,
                                ...
                                M = +f.rx || +f.r || 0,
                                L = +f.ry || +f.r || 0;
                            c.path = t.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x", a((T - M) * b), a((E - L) * b), a((T + M) * b), a((E + L) * b), a(T * b)), n._.dirty = 1
                        }
                        if ("clip-rect" in l) {
                        ...
                        if ("arrow-start" in l && S(m, l["arrow-start"]), "arrow-end" in l && S(m, l["arrow-end"], 1), null != l.opacity || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
                            var I = c.getElementsByTagName(h),
                                j = !1;
                            if (I = I && I[0], !I && (j = I = N(h)), "image" == n.type && l.src && (I.src = l.src), l.fill && (I.on = !0), null != I.on && "none" != l.fill && null !== l.fill || (I.on = !1), I.on && l.fill) {
